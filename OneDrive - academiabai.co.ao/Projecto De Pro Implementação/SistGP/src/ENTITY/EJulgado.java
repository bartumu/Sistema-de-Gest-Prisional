 ...
 */
@Entity
@Table(name = "e_julgado", catalog = "sistgp", schema = "")
@NamedQueries({
...
public class EJulgado implements Serializable {
    ...
    @Column(length = 45)
    private String pena;
    @JoinColumn(name = "idJulgamento", referencedColumnName = "idJulgamento", nullable = false, insertable = false, updatable = false)
    ...
    public String toString() {
        return "ENTITY.EJulgado[ eJulgadoPK=" + eJulgadoPK + " ]";
    }
